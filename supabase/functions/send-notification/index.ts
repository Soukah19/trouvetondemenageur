            ...
            <tr>
              <td style="background:#f8f9fa; padding:30px; text-align:center; border-top:1px solid #e0e0e0;">
                <p style="color:#999; font-size:14px; margin-bottom:10px;">
                  Besoin d'aide ? 📧 contact@trouvetondemenageur.fr
                </p>
    ...
    switch (type) {
      ...
      case "document_rejected":
        ...
        htmlContent = createEmailTemplate(
          ...
          `
            <p style="color:#666; font-size:16px; line-height:1.6; margin-bottom:24px;">
              Votre <strong>${data.documentType}</strong> n'a pas pu être vérifié automatiquement.
            </p>

            <div style="background:#fef3c7; padding:20px; border-radius:10px; margin-bottom:20px; border-left:4px solid #f59e0b;">
              <p style="color:#92400e; margin:0;"><strong>Raison:</strong> ${data.rejectionReason}</p>
            </div>
            ...
            <div style="background:#dbeafe; padding:16px; border-radius:10px;">
              <p style="color:#666; margin:0; font-size:14px;">
                <strong>ℹ️ Support:</strong> Si vous pensez qu'il s'agit d'une erreur, contactez notre support.
              </p>
            </div>
          `
        );
