                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-green-600">
                        {(contract.contract_data.financial.mover_price || Math.round(contract.contract_data.financial.total_amount / 1.3) || 0).toLocaleString('fr-FR')} €
                      </div>
                      <div className="text-xs text-gray-500">Votre devis accepté</div>
                    </div>
                  </div>
                ...
                <div className="bg-green-50 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Votre devis accepté</span>
                      <span className="font-medium">{(selectedContract.contract_data.financial.mover_price || Math.round(selectedContract.contract_data.financial.total_amount / 1.3)).toLocaleString('fr-FR')} €</span>
                    </div>
                    <div className="flex justify-between">
